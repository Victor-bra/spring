package com.ArrMod.blog.controllers;

import com.ArrMod.blog.models.Post;
import com.ArrMod.blog.repo.PostRepository;
...
public class BlogController {
    ...
    @GetMapping("/blogMain/add")
    public String blogAdd(Model model) {
        return "blogAdd";
    }

    @PostMapping("/blogMain/add")
    ...
    @PostMapping("/blogMain/{id}/remove")
